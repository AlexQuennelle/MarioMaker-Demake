...
class Level
{
	 ...
	 *  as much to the left and down as it can without encountering a cell that
	 *  has already been visited or that isn't ground.
	 ...
	 *  entire level using the data in @link grid @endlink. This is done using
